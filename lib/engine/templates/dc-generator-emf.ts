...
export const dcGeneratorEmf = defineTemplate<Params>({
  topic: "直流発電機の誘導起電力",
  subject: "機械",
  exam: "denken3",
  difficulty: 2,
  ...
  buildFrom({ terminal_voltage: V, armature_current: Ia, armature_resistance: Ra }) {
    ...
    return {
      ...
      defaultSolution: [
        `発電機は E=V+Ia·Ra（電動機の E=V−Ia·Ra と符号が逆）`,
        `E=${V}+${Ia}×${Ra}`,
        `E=${answerText}V`,
      ],
