  ...
  return {
    ...
    rubric: [
      ...
      },
      {
        id: "sin",
        points: 2,
        criterion: "sinθ=√(1−cos²θ) を正しく求める",
        aspect: "計算",
        keywords: ["sin", "√", "cos"],
      },
      { id: "substitute", points: 2, criterion: "数値を正しく代入する", aspect: "計算", keywords: [`${p}`, `${q}`] },
      {
        id: "result",
        points: 2,
      ...
      { id: "note", points: 1, criterion: "一次近似である旨（厳密式との別）に言及", aspect: "論述" },
    ],
