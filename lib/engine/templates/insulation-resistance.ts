...
const CASES: ReadonlyArray<Case> = [
  {
    ...
    reasons: {
      ...
      2: "より大きい方が安全と過大に見積もった当て推量（基準の最低値は0.1MΩ）",
    },
  },
  {
    ...
    reasons: {
      ...
      1: "切りのよい1MΩと当て推量、または高圧機器の判定基準との混同",
      2: "より大きい方が安全と過大に見積もった当て推量（本区分の最低値は0.2MΩ）",
    },
  },
  {
    cond: "使用電圧が300Vを超える",
    ...
    reasons: {
      ...
      1: "切りのよい1MΩと当て推量、または高圧機器の判定基準との混同",
      2: "0.4MΩの概数を大きく取り違えた当て推量（300V超の最低値は0.4MΩ）",
    },
  },
];
const CHOICE_POOL: ReadonlyArray<number> = [0.1, 0.2, 0.4, 1, 2];
