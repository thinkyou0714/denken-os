...
const CASES: ReadonlyArray<Case> = [
  {
    ...
    answer: 600,
    pool: [100, 300, 450, 600, 750],
    fact: "低圧: 交流600V以下・直流750V以下",
    reasons: {
      100: "単相100Vの公称電圧を区分の境界値と混同（低圧の上限は交流600V）",
  ...
  },
  {
    ...
    reasons: {
      ...
      22000: "特別高圧配電の公称電圧22000Vを境界値と取り違え（境界は7000V）",
    },
  },
];
