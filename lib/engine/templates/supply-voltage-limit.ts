...
const CASES: ReadonlyArray<Case> = [
  {
    ...
    answer: 107,
    pool: [95, 101, 106, 107, 110],
    reasons: {
      95: "下限値95Vを上限値と取り違え（101±6Vの上限は107V）",
  ...
  },
  {
    ...
    reasons: {
      ...
      222: "上限値222Vを下限値と取り違え（202±20Vの下限は182V）",
    },
  },
];
