...
| G9 | ✅ 完了・コミット済み | biome off 解除（noExplicitAny/noNonNullAssertion）・tsconfig に noImplicitReturns/noFallthroughCasesInSwitch/exactOptionalPropertyTypes 追加・追随修正36+20件（テストのみ overrides で noNonNullAssertion 緩和） |
