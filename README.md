...
| **オフライン学習アプリ（学習OS）** | `web/`（PWA・タブ型: 学習/復習/模試/進捗/公式/設定。**FSRS＋4段階評価**・弱点優先＋科目ドリル・**間違いノート**・**時間制限模試(合格判定)**・科目別到達度・試験カウントダウン・数式整形・自動生成220問。esbuild・Service Worker） | README ビジョン |
...
- **学習**: 弱点優先 or 科目ドリル。解答→即解説（数式整形）→**FSRS の4段階自己評価**（again/hard/good/easy）。
