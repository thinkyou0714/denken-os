...
- [`docs/architecture.md`](docs/architecture.md) — モジュール構成・依存グラフ・設計不変条件
- [`lib/README.md`](lib/README.md) — 各モジュールの責務索引
- [`docs/strategy/ideas/05-deep-audit-2026-06.md`](docs/strategy/ideas/05-deep-audit-2026-06.md) — コードベース深掘り監査100（根本原因×ベストプラクティス）
- [`CONTRIBUTING.md`](CONTRIBUTING.md) — 開発フローと `npm run verify`
- [`CHANGELOG.md`](CHANGELOG.md) — 変更履歴
- [`SECURITY.md`](SECURITY.md) — 脆弱性報告と機密情報の取扱い

Node バージョンは [`.nvmrc`](.nvmrc)（CI と同じ 22）。`nvm use` で揃う。
